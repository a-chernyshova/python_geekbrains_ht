...
class DealershipTest(unittest.TestCase):
    ...
    def test_add_user(self):
        h = 'test_pass2'.encode()
        h = hashlib.md5(h)
        result = Dealership1.create_user('test_log2', h.hexdigest(), 'MANAGER')
        self.assertEqual(result, "New user {} with role {} was added to DB".format('test_log2', 'MANAGER'))
    ...
    def test_del_user(self):
        ...
        self.assertEqual(result, TIMESTAMP + " INFO: Удален user ID{} в таблице Users".format(12))

    def test_add_car(self, ):
        result = Dealership1.add_car('lada3', 'zhiguli', 2017, 2, 5000)
        self.assertEqual(result, TIMESTAMP + " INFO: Модель {} добавлена в таблицу Cars".
    ...
    def test_add_dscar(self):
        ...
        self.assertEqual(result, TIMESTAMP + " INFO: Модель {} добавлена в таблицу "
    ...
    def test_change_amount(self):
        ...
        self.assertEqual(result, TIMESTAMP + " INFO: Обновлена запись {} в таблице "
    ...
    def test_del_dscar(self):
        ...
        self.assertEqual(result, TIMESTAMP + " INFO: Удалена запись {} в таблице "
                                             "Dealership".format(id_car))
    ...
    def test_add_lorry(self):
        ...
        self.assertEqual(result, TIMESTAMP + " INFO: Модель {} {} добавлена в таблицы Cars, "
    ...
    def test_del_lorry(self):
        ...
        self.assertEqual(result, TIMESTAMP + " INFO: Удалена запись ID{} в таблицах "
                                             "Lorries, Cars".format(id_car))
