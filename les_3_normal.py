...
print('Task#1', fibonacci(1, 5))
print('Task#1', fibonacci(3, 10))
...
print('Task#2',sort_to_max([2, 10, -12, 2.5, 20, -11, 4, 4, 0]))
...
print('Task#2',sort_to_max1([2, 10, -12, 2.5, 20, -11, 4, 4, 0]))
...
a = [1,2,5,6,8,9,10]
print('#task3',_filter(lambda x: x%2==0, a))
...
print('#task4',_isparalm([1,2], [2,4], [5,4], [4,2]))
